...
可以看到对每句话生成了长度为768的向量，这里输出了每个向量的前10位。

![image-20230309100352147](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230309100352147.png)
...
TextRank4ZH是针对中文文本的 TextRank 算法的python算法实现。
...
![image-20230309102927934](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230309102927934.png)